...
## credible and prediction intervals
nsamp <- 5000
samp <- sample.int(nrow(var.temp),nsamp)
...
ci_2 <- apply(ycred,2,quantile,c(0.025,0.5,0.975))  ## credible interval and median
pi_2 <- apply(ypred,2,quantile,c(0.025,0.975))
		## prediction interval
...
lines(order(xpred),order(ci_2[1,]),col=3,lty=2)	## lower CI
